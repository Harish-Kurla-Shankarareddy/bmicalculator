...
const translations = {
  ...
  fr: {
    title: 'Calculateur de Santé',
    subtitle: 'Calculez votre IMC et obtenez des recommandations personnalisées',
    weight: 'Poids',
    height: 'Taille',
    age: 'Âge',
    gender: 'Genre',
    ...
    calculate: 'Calculer Mes Résultats',
    resultsTitle: 'Vos Résultats de Santé',
    bmiResult: 'Résultat IMC',
    dailyCalories: 'Calories Quotidiennes',
    basedOnBMR: 'Basé sur le MB',
    estimateNote: 'Ceci est une estimation. Les besoins individuels peuvent varier en fonction du métabolisme et d\'autres facteurs.',
    healthTips: 'Conseils de Santé Personnalisés',
    exerciseRecommendations: 'Recomendations d\'Exercice',
    tailoredToBMI: 'Adapté à votre catégorie d\'IMC',
    examples: 'Exemples',
    ...
    overweight: 'Surpoids',
    obese: 'Obèse',
    underweightMsg: 'Envisagez de consulter un professionnel de la santé pour des stratégies de prise de poids saine.',
    normalWeightMsg: 'Vous êtes dans une fourchette de poids saine ! Continuez votre bon travail.',
    overweightMsg: 'Envisagez d\'adopter de meilleures habitudes alimentaires et d\'augmenter l\'activité physique.',
    obeseMsg: 'Consultez un professionnel de la santé pour des conseils personnalisés sur la gestion du poids.',
    enterWeight: 'Entrez votre poids',
    enterHeightCm: 'Entrez taille en cm',
    enterHeightFt: 'Pieds',
    enterHeightIn: 'Pouces',
